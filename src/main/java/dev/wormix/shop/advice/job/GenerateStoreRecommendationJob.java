...
import dev.wormix.shop.advice.usecase.FindCheapestStoreForBucketUseCase;
  ...
  public void execute() {
    ...
    do {
      ...
      for (UserModel user : usersPage.getContent()) {
        ...
        BestPriceStore bestStore = findCheapestStore.execute(fIndCheapestStoreForBucketCommand);
