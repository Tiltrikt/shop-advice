...
public class RecommendNearStoreUseCase implements UseCase<GenerateStoreRecommendationCommand, BestPriceStore> {
  ...
  @Override
  public @NotNull BestPriceStore execute(@NotNull GenerateStoreRecommendationCommand command) {
